...
var bot_token = '5298171183:AAHOcMHSty5P_M2DkOfgdMYt0l1gMd1xF6c'; //YOUR BOT TOKEN HERE
...
mongo.connect('mongodb+srv://anand123:fmxjB56uDFtz2DU3@cluster0.ncwnx.mongodb.net/myFirstDatabase?retryWrites=true&w=majority', { useUnifiedTopology: true }, (err, client) => {
    ...
    db = client.db('Earner_Loot_Cashback_bot');
        ...
        if (bots == 'Active') {
            ...
            if (flag == channel.length) {
                ...
                if (statdata.length == 0) {
                    ...
                    ctx.reply(
                        '<b>📊 Bot Live Stats 📊\n\n📤 Total Payouts : 0 ' + currency + '\n\n💡 Total Users: ' + members.length + ' Users\n\n🔎 Coded By: <a href="tg://user?id=5012914405">User</a></b>' , { parse_mode: 'html', reply_markup: { keyboard: [['💰 Balance'], ['🙌🏻 Invite', '🎁 Bonus', '🗂 Wallet'], ['💳 Withdraw', '📊 Statistics']], resize_keyboard: true } }
                    )
                } else {
